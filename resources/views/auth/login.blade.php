        ...
        <div class="col-md-8 col-lg-6 col-xl-4">
            <div class="card shadow-lg border-0 rounded-5 mt-3 overflow-hidden">
                <div class="card-header bg-gradient text-white text-center py-3 position-relative"
                    ...
                    <h3 class="fw-bold text-white mb-3" style="font-size: 1.8rem; text-shadow: 1px 1px 5px rgba(0, 0, 0, 0.3);color:#0057b8 !important">@lang('global.login_desc_wel')</h3>
                    ...
                    <form method="POST" action="{{ route('login') }}" class="px-1">
                        ...
                        <div class="form-floating mb-4">
                            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror"
                                ...
                                placeholder="@lang('global.login_email')" style="height: 50px; font-size: 1rem;">
                        ...
                        <div class="form-floating mb-4 position-relative">
                            <input id="password" type="password"
                                ...
                                autocomplete="current-password" placeholder="@lang('global.login_password')" style="height: 50px; font-size: 1rem;">
                        ...
                        <div class="d-grid gap-3">
                            <button class="btn btn-primary btn-lg" type="submit">@lang('global.login')</button>
                        </div>
