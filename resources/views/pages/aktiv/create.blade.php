...
@section('content')
        ...
        <form method="POST" action="{{ route('aktivs.store') }}" enctype="multipart/form-data" id="aktiv-form">
            ...
            <div class="row my-3">
                ...
                <div class="col-md-12">
                    ...
                    <div class="mb-3">
                        <label for="balance_keeper">Мулк эгаси (Юридик ёки Жисмоний шахс номи толиқ ёзилади)</label>
                    ...
                    <div class="mb-3">
                        <label for="faoliyat_xolati">Бугунги кунда ишламаяптими?</label>
                        <select name="faoliyat_xolati" id="faoliyat_xolati" class="form-control">
                            <option value="">Танланг</option>
                            <option value="work" {{ old('faoliyat_xolati') == 'work' ? 'selected' : '' }}>Ишламоқда
                            </option>
                    ...
                    <select class="form-control form-select mb-3" name="gas" id="gas">
                        ...
                        <option value="Мавжуд эмас" {{ old('gas') == 'Мавжуд эмас' ? 'selected' : '' }}>Мавжуд эмас
                        </option>
                    </select>
                    @error('gas')
                        <div class="text-danger">{{ $message }}</div>
                    ...
                    <select class="form-control form-select mb-3" name="water" id="water">
                        ...
                        <option value="Мавжуд эмас" {{ old('water') == 'Мавжуд эмас' ? 'selected' : '' }}>Мавжуд эмас
                        </option>
                    </select>
                    @error('water')
                        <div class="text-danger">{{ $message }}</div>
                    ...
                    <select class="form-control form-select mb-3" name="electricity" id="electricity">
                        ...
                        <option value="Мавжуд эмас" {{ old('electricity') == 'Мавжуд эмас' ? 'selected' : '' }}>Мавжуд
                            эмас
                        </option>
                    </select>
                    @error('electricity')
 ...
 --}}
                ...
                <select name="document_type" class="form-control">
                    ...
                    <div id="reason_not_active_container">
                        ...
                        <label for="reason_not_active" class="mt-3">Фаолият юритмаётганлиги сабаби:</label>
                        <select name="reason_not_active" class="form-control">
                            @php
                                $reasons = [
                                    'Кредит эхтиёжи бор' => 'Кредит эхтиёжи бор',
                                    'Тамирлаш жараёнида' => 'Тамирлаш жараёнида',
                                    'Ижарачи топа олмаяпти' => 'Ижарачи топа олмаяпти',
                                    'Фаолият вақтинча тўхтатилган' => 'Фаолият вақтинча тўхтатилган',
                                    'Бошқа сабаблар' => 'Бошқа сабаблар',
                                ];
                                $selectedReason = old('reason_not_active', $aktiv->reason_not_active ?? '');
                            @endphp
                        ...
                        {{-- <label for="ready_for_rent" class="mt-3">Ижарага беришга тайёрлиги:</label>
 ...
 --}}
                    ...
                    <!-- Ижарачи тел рақами -->
                    <label for="tenant_phone_number">Мулк эгаси тел рақами</label>
                    ...
                    {{-- <div class="col-lg-12 col-md-12 col-12 mb-3">
                        ...
                        <select name="ijaraga_berishga_tayyorligi" id="ijaraga_berishga_tayyorligi" class="form-control">
                            ...
                            <option value="not" {{ old('ijaraga_berishga_tayyorligi') == 'not' ? 'selected' : '' }}>Йўқ
                                ози
                                бошқармоқчи
                            </option>
                        </select>
                    ...
                    <div class="col-lg-12 col-md-12 col-12 mb-3" id="ijara_summa_wanted_container"
                        style="display: none;">
